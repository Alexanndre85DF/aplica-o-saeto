...
_TABELAS_COM_ID = {"municipios", "escolas", "aplicadores", "viagens", "vagas", "vaga_extras", "diaria_ajustes", "alunos_especiais"}
_CONFLITO = {
    "municipios": "nome",
    "escolas": "codigo",
    "aplicadores": "codigo",
...
def ensure_colunas(conn) -> None:
    ...
    conn.execute("CREATE INDEX IF NOT EXISTS idx_alunos_escola_turma ON alunos_especiais(escola_id, turma)")
...
def _migrar_sqlite_se_postgres_vazio() -> None:
    ...
    try:
        ...
        with get_db() as pg:
            ...
            if "alunos_especiais" in tabelas:
                _copiar_tabela(
                    src,
                    pg,
                    "alunos_especiais",
            ...
            if "vaga_extras" in tabelas:
                _copiar_tabela(
                    ...
                    pg,
                    "vaga_extras",
                    ["id", "vaga_id", "aplicador_id", "aluno_id"],
                )
            ...
            for tabela in ("municipios", "escolas", "aplicadores", "viagens", "vagas", "alunos_especiais", "vaga_extras", "diaria_ajustes"):
